...
# Constants
DEVICE_NAME = "ABMT Peripheral"  # Update this to match your device name
ABMT_SERVICE_UUID = "4d7cf781-6054-4c04-b3fd-0de391356984"    # ADC BLE Max Throughput service
ABMT_DATA_CHAR_UUID = "4d7cf782-6054-4c04-b3fd-0de391356984"  # Data characteristic
...
def main():
    try:
        ...
        if 'target_peripheral' in locals() and target_peripheral.is_connected():
            try:
                target_peripheral.unsubscribe(ABMT_SERVICE_UUID, ABMT_DATA_CHAR_UUID)
            except:
                pass
